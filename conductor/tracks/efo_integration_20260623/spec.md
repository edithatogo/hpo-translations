# Specification - Integrate EFO into terminology and translation support

## Objective
Introduce EFO as a governed terminology source for the HPO translation workflow where it improves concept alignment, multilingual review, or domain-specific validation.

## Source Profile
- Languages: English only.
- GitHub repositories:
- https://github.com/EBISPOT/efo
- Source note: EBI SPOT EFO repository.

## Usefulness
Experimental factor, disease, trait, and assay context for biomedical mappings.
