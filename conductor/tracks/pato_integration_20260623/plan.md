# Plan - Integrate PATO into terminology and translation support

This plan introduces PATO into the project where it can improve terminology alignment, multilingual review, or validation.

## Implementation Result
Phase 0 governance is implemented as metadata-only and remains blocked before payload ingestion. PATO may only be used for source-authority, version-pinning, and phenotypic-quality governance scaffolding until terms review confirms the release channel, version, and redistribution status.
...
- [ ] **Task 1:** Identify where PATO helps: crosswalks, synonym review, multilingual label comparison, or domain validation.
