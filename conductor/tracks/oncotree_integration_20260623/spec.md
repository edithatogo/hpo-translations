# Specification - Integrate OncoTree into terminology and translation support

## Objective
Introduce OncoTree as a governed terminology source for the HPO translation workflow where it improves concept alignment, multilingual review, or domain-specific validation.

## Source Profile
- Languages: English only.
- GitHub repositories:
- https://github.com/cBioPortal/oncotree
- Source note: cBioPortal OncoTree repository.

## Usefulness
Cancer type normalization for oncology-specific phenotype and disease contexts.
