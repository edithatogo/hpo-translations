...
- [~] **Task 2:** Pin the HPO release and every source release selected for the pilot; complete source access, license, credential, source-authority, language, and version checks. HPO `v2026-06-23`, the four official mapping families, and public supplementary release candidates are reviewed. Payload-free archive receipts now pin Disease Ontology `v2026-07-31`, MP `v2026-07-22`, PATO `v2025-05-14`, and uPheno `v2025-10-12` to checksums at one owner-only private-archive revision. These receipts establish version and integrity evidence only: they do not authorize source use, payload retrieval, source-atom ingestion, or close G1. The final pilot source set, DeCS version, remaining provider permissions, credential custody, and human license decisions remain open. (`3ff429e`, review fix `e410f47`, `f3a9584`)
