...
- [~] **Task 4:** Close source, licence, ethics, privacy, reviewer-consent, language-working-group, and community model-use gates. Wave 1 is complete: the maintainer instruction records conditional, version-pinned internal planning scopes for Mondo, WHO ICF, Uberon, and PATO with attribution, lineage, and source-specific restrictions. The source-licence manifest is conditional for those four roles, but payload retrieval, mapping/adaptation, redistribution, empirical work, and promotion remain blocked. PRO-CTCAE and DeCS remain externally blocked on sender identity, and all G2 gates remain pending. Wave 2—ethics/privacy plus separate Spanish and Japanese language-scope decisions—is next. (`5e8ff7f`, `8070f4d`, `176e7e2`, `8d0ca96`, blocker plan `b4f31f7`, Wave 1 `7881787`)
