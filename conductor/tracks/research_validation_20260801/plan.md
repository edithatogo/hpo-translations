...
- [~] **Task 4:** Close source, licence, ethics, privacy, reviewer-consent, language-working-group, and community model-use gates. The G1/G2 docket now contains a validated blocker-resolution plan: Option B with Spanish, Japanese, and the smallest bounded approved source subset is the recommended minimum viable Stage 1 route; Option A remains the expansion target before G3; Options C and D are deterministic fallbacks. Five ordered waves cover minimum source scope, ethics/privacy and language scope, reviewer capacity, optional expansion, and manifest reconciliation plus freeze. The action pack, receipt template, and live route review are prepared. Conditional internal-use recommendations cover Mondo, WHO ICF, Uberon, and PATO but record no accountable licence decision or payload authority. PRO-CTCAE and DeCS remain externally blocked on sender identity. All approvals and payload access remain pending. (`5e8ff7f`, `8070f4d`, `176e7e2`, `8d0ca96`, blocker plan `b4f31f7`)
