# Plan - Integrate FMA into terminology and translation support

This plan introduces FMA into the project where it can improve terminology alignment, multilingual review, or validation.

## Implementation Result
Phase 0 governance is implemented as metadata-only and remains blocked before payload ingestion. FMA may only be used for anatomy-governance scaffolding until public ontology terms review confirms the release channel, version, and redistribution status.
