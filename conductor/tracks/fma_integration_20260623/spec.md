# Specification - Integrate FMA into terminology and translation support

## Objective
Introduce FMA as a governed terminology source for the HPO translation workflow where it improves concept alignment, multilingual review, or domain-specific validation.

## Source Profile
- Languages: English only.
- GitHub repositories:
- None confirmed.
- Source note: No official public GitHub repository confirmed; use authoritative FMA distribution sources.

## Usefulness
Anatomy normalization for phenotype labels and definitions.
