# Plan - Integrate uPheno into terminology and translation support

This plan introduces uPheno into the project where it can improve terminology alignment, multilingual review, or validation.

## Implementation Result
Phase 0 governance is implemented as metadata-only and remains blocked before payload ingestion. uPheno may only be used for source-authority, version-pinning, and cross-species phenotype-pattern governance scaffolding until terms review confirms the release channel, version, and redistribution status.
...
- [x] **Task 1:** Define source retrieval path without committing restricted payloads.
  - Use the pinned uPheno release metadata and local-only cache; component payloads remain blocked pending licence matrix review.
...
- [x] **Task 1:** Identify uPheno use for cross-species pattern validation and identifier conflict detection; source terms remain blocked.
...
- [x] **Task 1:** Validate governance schema, provenance, and licence metadata; component terms remain blocked.
