# Specification - Integrate LDDB into terminology and translation support

## Objective
Introduce LDDB as a governed terminology source for the HPO translation workflow where it improves concept alignment, multilingual review, or domain-specific validation.

## Source Profile
- Languages: English only.
- GitHub repositories:
- None confirmed.
- Source note: No official public GitHub repository confirmed; identify authoritative source before implementation.

## Usefulness
Specialized disease database context where licensing and source authority can be verified.
