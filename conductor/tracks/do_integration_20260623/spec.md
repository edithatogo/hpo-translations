# Specification - Integrate Disease Ontology into terminology and translation support

## Objective
Introduce Disease Ontology as a governed terminology source for the HPO translation workflow where it improves concept alignment, multilingual review, or domain-specific validation.

## Source Profile
- Languages: English only.
- GitHub repositories:
- https://github.com/DiseaseOntology/HumanDiseaseOntology
- Source note: Human Disease Ontology repository.

## Usefulness
Disease normalization and disease-phenotype crosswalk review.
