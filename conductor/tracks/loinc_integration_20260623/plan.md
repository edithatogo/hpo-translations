# Plan - Integrate LOINC into terminology and translation support

This plan introduces LOINC into the project where it can improve terminology alignment, multilingual review, or validation.
...
- Generated governance record: `ontology_network/source_registry.json` and `ontology_network/source_access_matrix.*` entries for `loinc_integration_20260623`.
