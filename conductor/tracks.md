...
| `research_validation_20260801` | `planned` | `P0` | `mixed_public_and_restricted_metadata_only` | `conductor_validation_20260623, translation_agents_20260622, ontology_network_20260623:phase_1_registry_contract` | `language_candidate_tracks` | `research-validation` | `not_started` | `not_started` | `not_opened` |
